...
import CustomerInsightsPopup from './CustomerInsightsPopup';
import AgentInsightsPopup from './AgentInsightsPopup';
...
const DetailedAnalysis = () => {
  ...
  const [totalDuration] = useState(125); // 125 seconds = 2:05
  ...
  return (
    <>
      <div className="space-y-6">
        {/* Customer and Agent Insights Cards */}
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1 flex items-center space-x-2">
                <div className="flex items-center space-x-px flex-1 h-8 overflow-hidden">
                  {generateWaveform()}
                </div>
            ...
            <div className="relative">
              ...
              <div className="relative h-16 bg-gray-50 rounded-lg px-4 py-2 overflow-hidden">
      ...
      {showCustomerPopup && <CustomerInsightsPopup onClose={() => setShowCustomerPopup(false)} />}
      {showAgentPopup && <AgentInsightsPopup onClose={() => setShowAgentPopup(false)} />}
    </>
  );
};
