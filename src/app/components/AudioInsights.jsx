...
import { Home, User, Mic, Users, Star } from 'lucide-react';
...
const AudioInsightsDashboard = () => {
  ...
  const UserAvatar = () => (
    <div className="flex items-center space-x-2">
      <div className="w-8 h-8 rounded-full overflow-hidden">
        <Image src="/profilephoto.png" alt="User" width={32} height={32} />
      </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <header className="bg-white border-b border-gray-200 px-6 py-3 shadow-sm">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <O2Logo />
            <div className="ml-6">
              <div className="text-sm px-4 py-2 bg-blue-50 border-b-2 border-blue-500 text-blue-700 font-medium rounded-t">
                Call Summary
              </div>
            </div>
          </div>
      ...
      <main className="bg-blue-50 flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
